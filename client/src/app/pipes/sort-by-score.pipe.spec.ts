...
const MOCK_PLAYER_0 = { username: 'z', score: 1000, bonusCount: 0, isPlaying: true };
const MOCK_PLAYER_1 = { username: 'ab', score: 100, bonusCount: 0, isPlaying: true };
const MOCK_PLAYER_2 = { username: 'b', score: 50, bonusCount: 0, isPlaying: false };
const MOCK_PLAYER_3 = { username: 'c', score: 50, bonusCount: 0, isPlaying: false };
const MOCK_PLAYER_4 = { username: 'aa', score: 0, bonusCount: 0, isPlaying: true };
